const { mockServers } = require('./mock-data');
 ...
 */
async function main() {
  console.log('Starting MCP Directory Mock Crawler');
  ...
  try {
    ...
    console.log(`Processing ${mockServers.length} mock servers`);
    summary.crawled = mockServers.length;
